                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            @endif
                            <form action="admin/charity/editvideo/{!! $charity['id'] !!}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row">
                                    <label class="col-sm-1 col-form-label">Link</label>
                                    <div class="col-sm-11">
                                    <input type="text" class="form-control linkvideo" name="path"
                                           placeholder="https://www.youtube.com/watch?v="  value="{!! $charity['path'] !!}" >
                                           <iframe style="height: 300px;" width="400px" src="@if(isset($charity['path'])) 
                                            https://www.youtube.com/embed/{!! $charity['path'] !!} 
