                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-block"> 
                            <a href="admin/videos/add" class="text-light">
                                <button class=" btn btn-primary float-right mb-3" >Add</button>
                            </a>
                            <button style="margin-bottom: 10px" data-url="{{ url('ajax/deleteall_videos') }}" class="btn btn-danger delete_all">Delete_all</button>
                                ...
                                <table class="table table-bordered nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <td><input type="checkbox" class="sub_chk" data-id="{!! $value['id'] !!}"></td>
                                            ...
                                            <td class="center"><a class="btn btn-warning " href="admin/videos/edit/{!! $value['id'] !!}">Edit</a></td>
                                            <td class="center "><a href="javascript:void(0)" data-url="{{ url('ajax/delete_videos', $value['id'] ) }}" class="btn btn-danger delete-videos">Delete</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.delete-videos').on('click', function() {
